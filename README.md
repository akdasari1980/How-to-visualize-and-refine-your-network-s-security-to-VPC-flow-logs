...
As illustrated in the preceding diagram, this is how the data flow in this model:
...
3.1.     Update the **AWS Management Console**, on the **service** menu, click **EC2**.
...
7.12.     For Backup S3 bucket, choose S3 bucket name from the drop-down list, or choose to Create S3 bucket. Choose **Next**.
...
8.2.     Choose **Logs** in the navigation pane, and select the checkbox next to **Flowlogs** under Log Groups.
